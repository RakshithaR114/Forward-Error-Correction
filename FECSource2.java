...
public class FECSource2 extends JFrame
{
	...
	private void initializeComponent()
	{
		...
		addComponent(contentPane, jTextField1, 27,71,240,30);
	...
	private void jButton2_actionPerformed(ActionEvent e)
	{
		if (k!=5)
		{
			String msg="Load The File and then Start FEC Encoding";
	...
	private void jButton3_actionPerformed(ActionEvent e)
	{
		if (k!=10)
		{
			String msg="Load The File, Complete the FEC Encoding and then Start Interleaving";
			JOptionPane op=new JOptionPane();
			op.showMessageDialog(op,msg)	;
		}
		else
	...
	private void jButton4_actionPerformed(ActionEvent e)
	{
		if (k!=15)
		{
			String msg="Complete the FEC Encoding, Interleaving and then Send the Packets";
			JOptionPane op=new JOptionPane();
			op.showMessageDialog(op,msg)	;
		}
		else
